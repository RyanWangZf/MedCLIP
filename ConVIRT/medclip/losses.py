...
class ImageTextContrastiveLoss(nn.Module):
    ...
    def forward(self, 
        ...
        **kwargs,
        ...
        if img_labels is None or text_labels is None:
            ...
            label_sim = F.softmax(label_sim, 1)
    ...
    def _soft_clip_loss(self, logits_per_img, soft_label):
        ...
        '''
        image_loss = self._soft_xent_loss(logits_per_img, soft_label)
        caption_loss = self._soft_xent_loss(logits_per_img.T, soft_label.T)
