    ...
    def __init__(self, 
        ...
        if imgtransform is None:
            self.transform = transforms.Compose([
                transforms.Resize((224,224)), # take 224x224 inputs
                transforms.ToTensor(),
...
freeze = False
vision_model = gloria.load_img_classification_model(num_cls=num_class, freeze_encoder=freeze, device=device)
clf = GloriaClassifier(vision_model=vision_model,num_class=num_class, mode=mode)
